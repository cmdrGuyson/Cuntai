module.exports = {
	name: "findpornv",
	aliases: ["findv", "find porn video", "findpornvid", "pornvid", "porn video", "pornvideo"],
	description: "Find a random porn video",
		...
		collector.on("end", async collected => {
			...
			try {
				...
				const serverInfoEmbed = new Discord.RichEmbed()
					.setColor("#4BA4F0")
					.setTitle("Random Porn Video")
					.setImage(image)
					.addField('Link', body.videos[randomVideo].video.url, true)
